...
class ClimatologyMapSeaIceVolumeTendencyThermo(AnalysisTask):
    """
    ...
    def __init__(self, config, mpas_climatology_task, hemisphere,
        ...
        task_name = f'climatologyMapSeaIceVolumeTendencyThermo{hemisphere}'

        field_name = 'VolumeTendencyThermodynamics'
        title_long = 'Sea Ice Volume Tendency due to Thermodynamics'
        ...
        variable_list = ['timeMonthly_avg_iceVolumeTendencyThermodynamics']
...
#                    else:
                ...
                subtask.set_plot_info(
                    outFileLabel=f'seaice_volumetendthermo{hemisphere}',
...
class RemapMpasSeaIceTendencyClimatology(RemapMpasClimatologySubtask):
    ...
    def __init__(self, mpas_climatology_task, parent_task, climatology_name,
        ...
        subtask_name = f'remapMpasClimatology_VolumeTendencyThermodynamics'
    ...
    def customize_masked_climatology(self, climatology, season):
        ...
        climatology['VolumeTendencyThermodynamics'] = tendency
        climatology.VolumeTendencyThermodynamics.attrs['units'] = 'm/yr'
