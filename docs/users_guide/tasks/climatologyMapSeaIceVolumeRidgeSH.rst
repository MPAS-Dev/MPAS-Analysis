.. _task_climatologyMapSeaIceVolumeRidgeSH:

climatologyMapSeaIceVolumeRidgeSH
=======================================

An analysis task for plotting maps of Antarctic sea ice ridged volume per unit ice area.
...
.. image:: examples/ice_ridgevolume_sh.png
   :width: 720 px
   :align: center
