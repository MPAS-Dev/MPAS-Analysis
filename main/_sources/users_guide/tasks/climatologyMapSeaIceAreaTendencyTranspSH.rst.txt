.. _task_climatologyMapSeaIceAreaTendencyTranspSH:

climatologyMapSeaIceAreaTendencyTranspSH
========================================

An analysis task for plotting maps of Antarctic sea ice area tendency due to transport.
...
.. image:: examples/ice_areatendtransp_sh.png
   :width: 720 px
   :align: center
